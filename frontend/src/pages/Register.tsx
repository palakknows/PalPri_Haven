...
const mutation=useMutation(apiClient.register,{
    ...
    return ( <form className="flex flex-col gap-5" onSubmit={onSubmit}>
        ...
        <div className="flex flex-col md:flex-row gap-5">
            ...
            <label className="text-gray=700 text-sm font-bold">Email
            ...
            <label className="text-gray=700 text-sm font-bold">Password
            <input type="password" className="border rounded w-full py-1 px-2 font-normal"
            {...register("password",{required:"This field is required",minLength:{value:6,message:"Password should be atleast 6 characters"}})}></input>
            {errors.password && (
                <span className="text-red-500 text-sm">{errors.password.message}</span>)}
            </label>

            <label className="text-gray=700 text-sm font-bold">Confirm password
            <input type="password" className="border rounded w-full py-1 px-2 font-normal"
            ...
            <span>
                <button type="submit" className="bg-blue-600 text-white p-2 font-bold hover:bg-blue-200">Create account</button>
            </span>
        </form>
